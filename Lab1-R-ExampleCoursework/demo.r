...
propSaleEss <- sub
set(propSale, ppdcategory == "A" && recordstatus == "A")
...
head(res)
p1 <- ggplot(data = res, aes(x = month, y = meanprice)) +
    geom_bar(stat = "identity", position = position_dodge(0.9)) +
    theme(axis.text.x = element_text(size = 10, angle = 90, hjust = 1))
p2 <- ggplot(data = res, aes(x = month, y = sumcount)) +
    geom_bar(stat = "identity", position = position_dodge(0.9)) +
    theme(axis.text.x = element_text(size = 10, angle = 90, hjust = 1))
...
ggplot(data = res2, aes(x = year, y = price, fill = type)) +
    geom_bar(stat = "identity", position = position_dodge(0.9)) +
    theme(axis.text.x = element_text(size = 10, angle = 90, hjust = 1))


ggplot(data = res, aes(x = year, y = price, fill = age)) +
    geom_bar(stat = "identity", position = position_dodge(0.9)) +
    theme(axis.text.x = element_text(size = 10, angle = 90, hjust = 1))
...
ggplot(data = res, aes(x = year, y = meanprice, fill = county)) +
    geom_bar(stat = "identity", position = position_dodge(0.9)) +
    theme(axis.text.x = element_text(size = 10, angle = 90, hjust = 1)) +
